...
library(ggplot2)
install.packages( "D:/Spring_2021/STAT515_Prof.ScottBruce/After final/miderm-final-projects/DMwR_0.4.1.tar.gz",repos=NULL, type="source" )
library(DMwR) 
```
...
```{r}
df <- read.csv("D:/Spring_2021/STAT 515_Prof.ScottBruce/Final/Churn_Modelling.csv")
```
